...
import getOrgWideEmailAddresses from '@salesforce/apex/AccountPreviewEmailController.getOrgWideEmailAddresses';
import getEmailSignature from '@salesforce/apex/AccountPreviewEmailController.getEmailSignature';
import getRelatedFiles from '@salesforce/apex/AccountPreviewEmailController.getRelatedFiles';
import getEmailBody from '@salesforce/apex/AccountPreviewEmailController.getEmailBody';
import saveSignature from '@salesforce/apex/AccountPreviewEmailController.saveSignature';
import sendEmail from '@salesforce/apex/AccountPreviewEmailController.sendEmail';

export default class AccountPreviewEmail extends LightningElement {
    @api
    get recordId() {
    ...
    @track templateOptions = [
        {
            label: 'Ineligible HIP letter',
            value: 'IneligibleHIPletter'
        }, 
        {
    ...
    logError(message, error) {
        if (error !== undefined) {
            console.error(`[AccountPreviewEmail] ${message}`, error);
        } else {
            console.error(`[AccountPreviewEmail] ${message}`);
        }
    }
